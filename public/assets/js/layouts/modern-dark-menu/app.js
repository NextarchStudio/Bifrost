    ...
    var inBuiltfunctionality = {
        ...
        onCheckandChangeSidebarActiveClass: function() {
            if (document.body.classList.contains('alt-menu')) {
                var expanded = document.querySelector('.sidebar-wrapper li.menu.active [aria-expanded="true"]');
                if (expanded) {
        ...
        function sidebarCloser() {
            ...
            if (window.innerWidth <= 991 ) {
                ...
                if (!document.querySelector('body').classList.contains('alt-menu')) {
                    ...
                    var expandedNode = document.querySelector('.sidebar-wrapper [aria-expanded="true"]');
                    if (expandedNode && expandedNode.parentNode && expandedNode.parentNode.querySelector('.collapse')) {
                        expandedNode.parentNode.querySelector('.collapse').classList.remove('show');
                    }
                }
            }
        }
