...
export const systemSettings = mysqlTable("system_settings", {
  ...
  smtpFromEmail: varchar("smtp_from_email", { length: 180 }),
  smtpFromName: varchar("smtp_from_name", { length: 180 }),
  smtpHost: varchar("smtp_host", { length: 180 }),
  smtpPort: int("smtp_port", { unsigned: true }),
  smtpUser: varchar("smtp_user", { length: 180 }),
  smtpPass: varchar("smtp_pass", { length: 255 }),
  smtpCrypto: varchar("smtp_crypto", { length: 10 }),
