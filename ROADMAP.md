...
| Fase 5 – transport, samband og shop | Pågår | Transport og samband er implementert i API og Web, inkludert ruteestimat, kjørebok, sambandssett, utlån, delretur og bytte. Shop, crew clothing og import/eksport gjenstår. |
...
5. Paritetstest fase 4, transport og samband mot anonymiserte data, og fortsett deretter med shop/crew clothing.
...
**Status:** Pågår. Transport- og sambandsdelene er implementert i kode, men er ikke verifisert mot anonymisert staging-database. Shop, crew clothing og import/eksport gjenstår.
