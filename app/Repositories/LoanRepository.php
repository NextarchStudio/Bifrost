...
class LoanRepository
{
    ...
    {
        $builder = $this->loans
            ->select('equipment_loans.*, equipment.name AS equipment_name, users.name AS wannabe_name, users.first_name AS wannabe_first_name, users.last_name AS wannabe_last_name')
