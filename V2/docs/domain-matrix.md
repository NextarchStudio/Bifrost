...
| `transport_ansvarlig` | Seedet og vist i admin/statistikk, men ikke brukt i V1-rutefilteret for transport | Ja, avvik må avklares før transport migreres |
...
3. Kartlegg controller- og servicenivåregler per handling før hver gjenstående modul implementeres.
