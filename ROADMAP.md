...
| Fase 4 – utlån og forespørsler | Nær ferdig | Transaksjonelt flerlinje-utlån, retur, person-/badge-oppslag, private-utstyrsregler, utstyrsforespørsler, kjøretøy, kompetanse/KDO og kjøretøylån er implementert i API og Web. Profilvisning av egen historikk, statusvarsler og paritetstest mot stagingdata gjenstår. |
...
5. Fullfør fase 4 med profilvisning av egne lån/forespørsler og statusvarsler, og start deretter transportmodulen.
