...
| Fase 6 – oppgaver, feedback og admin | Pågår | Oppgaver, feedback/varsler og kjerneadmin for brukere, roller, aktiv-status, kompetanser og krypterte innstillinger er implementert. Statistikk, destruktiv cache-nullstilling, dashboard og globalt søk gjenstår. |
...
6. Fortsett fase 6 med statistikk og kontrollert cache-nullstilling, deretter dashboard og globalt søk.
...
**Status:** Pågår. Oppgaver er implementert i API og Web med egen-/lederinnsyn, tildeling, prioritet, frist, status og valgfri transportkobling. Feedback, lokalt lagrede bildevedlegg og globale statusvarsler er implementert med V1-rollene og eksisterende tabeller. Kjerneadmin for brukere, roller, aktiv-status, kompetanser og krypterte innstillinger er levert; statistikk, kontrollert cache-nullstilling, dashboard og globalt søk gjenstår.
