...
| Admin og statistikk | `developer`, `chief`, `co-chief`; systeminnstillinger/cache: `developer` | Brukere, roller, aktiv-status, kompetanser, krypterte systeminnstillinger og alle V1-statistikkgrupper er levert; destruktiv crew-cache-/brukernullstilling gjenstår | Admin- og statistikk-API/Web levert med audit og tilgangstester; cache-nullstilling pågår |
...
| `/api/v1/admin*` | Bruker-/rolleadmin og statistikk: `developer`, `chief`, `co-chief`; systeminnstillinger: `developer` | Ja; bruker, rolle, aktiv-status, kompetanser og innstillinger har audit; statistikk er lesebasert; hemmeligheter krypteres og eksponeres ikke | Ja |
